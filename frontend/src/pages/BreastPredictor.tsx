            ...
            {result ? (
              ...
              >
                ...
                <div className="mt-auto pt-6 border-t border-white/5">
                  <button className="w-full flex items-center justify-center py-3 text-sm font-medium text-text-main hover:text-primary transition-colors bg-white/5 hover:bg-white/10 rounded-xl">
