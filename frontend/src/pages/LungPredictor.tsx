...
import { Upload, X, FileImage, ShieldAlert, ArrowLeft, RefreshCw, Download, Zap, Activity } from 'lucide-react';
...
const LungPredictor = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('/predict/lung-pred', formData, {
        headers: {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="mb-10">
        <h1 className="text-3xl font-bold mb-3 text-teal-400">Lung Cancer Classifier</h1>
        <p className="text-text-muted">Upload a CT scan image to analyze for potential pulmonary nodules and cancerous characteristics.</p>
      </div>

      <div className="grid md:grid-cols-5 gap-8">
        <div className="md:col-span-3">
          <div className="card p-1 border-teal-400/20">
            {!previewUrl ? (
              <div
              ...
              >
                ...
                <label
                  htmlFor="file-upload"
                  className="btn-primary cursor-pointer inline-block !from-teal-500 !to-cyan-500 shadow-teal-500/20"
                >
                  Select File
                </label>
              </div>
              ...
              <div className="p-6">
                ...
                {!result ? (
                  <button
                    ...
                    className="btn-primary w-full flex items-center justify-center py-4 !from-teal-500 !to-cyan-500 shadow-teal-500/20"
                  >
                    {isUploading ? (
                      <>
